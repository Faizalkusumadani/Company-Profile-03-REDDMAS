...
import {
  getCreativeBrandBySlug,
  getCreativeBrandSlugs,
} from "@/data/data-bisnis-creative";
...
export function generateStaticParams() {
  return getCreativeBrandSlugs().map((slug) => ({ slug }));
}
...
export async function generateMetadata({
  ...
  const brand = getCreativeBrandBySlug(slug);
  if (!brand) return {};
  ...
  return {
    title: `${brand.name} | Creative, IP Licensing & Merchandising`,
    description: desc,
    openGraph: {
      title: `Reddmasgroup | ${brand.name}`,
      description: desc,
      url: `${siteUrl}/bisnis/creative/${slug}`,
    },
    alternates: {
      canonical: `${siteUrl}/bisnis/creative/${slug}`,
      languages: {
        "id-ID": `${siteUrl}/id/bisnis/creative/${slug}`,
        "en-US": `${siteUrl}/en/bisnis/creative/${slug}`,
      },
    },
  };
}
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs font-semibold uppercase tracking-[0.2em] text-gray-500">
                Creative, IP Licensing &amp; Merchandising
              </span>
            </div>
