...
import {
  getInformationBrandBySlug,
  getInformationBrandSlugs,
} from "@/data/data-bisnis-information";
...
export function generateStaticParams() {
  return getInformationBrandSlugs().map((slug) => ({ slug }));
}
...
export async function generateMetadata({
  ...
  const brand = getInformationBrandBySlug(slug);
  if (!brand) return {};
  ...
  return {
    title: `${brand.name} | Information Technology Solutions`,
    description: desc,
    openGraph: {
      title: `Reddmasgroup | ${brand.name}`,
      description: desc,
      url: `${siteUrl}/bisnis/information/${slug}`,
    },
    alternates: {
      canonical: `${siteUrl}/bisnis/information/${slug}`,
      languages: {
        "id-ID": `${siteUrl}/id/bisnis/information/${slug}`,
        "en-US": `${siteUrl}/en/bisnis/information/${slug}`,
      },
    },
  };
}
